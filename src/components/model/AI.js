import ChatMessage from '../GplatesCodeEditor/Chat.js';
...
class AI {
    ...
    static async getResponseMessage(messages) {
        ...
        const guidelines = [
            "You are a bot that can generate JS code or answer questions.",
            ...
            "You will add the 'js' fields only if you changed them. When adding any code field, format it in a readable way.",
            "Always include the scripts inside the 'js' field",
